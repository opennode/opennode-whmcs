...
function get_username($userid) {
    // XXX stub to return userid during the cleanup phase
    return $userid;
}
...
function get_balance_limit($userid) {
       ...
       $result = mysql_query("SELECT value FROM tblcustomfieldsvalues WHERE fieldid = " .
                    $balance_customfieldid . " and relid = " . $userid);
